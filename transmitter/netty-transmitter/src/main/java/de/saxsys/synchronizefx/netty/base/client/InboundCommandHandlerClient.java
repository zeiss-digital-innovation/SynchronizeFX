 ...
 */
class InboundCommandHandlerClient extends SimpleChannelInboundHandler<List<Command>> {
    ...
    @Override
    protected void channelRead0(final ChannelHandlerContext ctx, final List<Command> msg) throws Exception {
        callback.recive(msg);
    }
}
